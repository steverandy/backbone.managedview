...
(function() {
  ...
  Backbone.ManagedView = (function(_super) {
    ...
    function ManagedView() {
      ...
      this.render = __bind(this.render, this);      _ref = ManagedView.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    ManagedView.prototype.collectViews = function() {
      var childView, name, view, views, _i, _len, _ref1;
    ...
    ManagedView.prototype.renderViews = function() {
      var $el, childView, insert, name, view, _ref1, _results;
